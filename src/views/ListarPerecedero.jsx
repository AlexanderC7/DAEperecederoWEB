// src/pages/ListarPerecederos.jsx

import React, { useState } from 'react';
import axios from 'axios';
import { useNavigate } from 'react-router-dom';

const ListarPerecederos = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">Listar Perecederos</h1>
      <div className="mb-4">
        ...
        />
        <button onClick={manejarListado} className="bg-blue-600 text-white px-4 py-2 rounded">
          Listar
        </button>
      </div>
...
export default ListarPerecederos;